...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\x9c\x02\n" +
	"\fGreetService\x120\n" +
	"\bSayHello\x12\x0e.greet.NoParam\x1a\x14.greet.HelloResponse\x12C\n" +
	"\x17SayHelloServerStreaming\x12\x10.greet.NamesList\x1a\x14.greet.HelloResponse0\x01\x12D\n" +
	"\x17SayHelloClientStreaming\x12\x13.greet.HelloRequest\x1a\x12.greet.MessageList(\x01\x12O\n" +
	"\x1eSayHelloBidirectionalStreaming\x12\x13.greet.HelloRequest\x1a\x14.greet.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_goTypes = []any{
	...
	(*MessageList)(nil),   // 4: greet.MessageList
}
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 2: greet.GreetService.SayHelloClientStreaming:input_type -> greet.HelloRequest
	2, // 3: greet.GreetService.SayHelloBidirectionalStreaming:input_type -> greet.HelloRequest
	1, // 4: greet.GreetService.SayHello:output_type -> greet.HelloResponse
	1, // 5: greet.GreetService.SayHelloServerStreaming:output_type -> greet.HelloResponse
	4, // 6: greet.GreetService.SayHelloClientStreaming:output_type -> greet.MessageList
	1, // 7: greet.GreetService.SayHelloBidirectionalStreaming:output_type -> greet.HelloResponse
